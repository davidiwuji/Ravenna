        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="w-full max-w-md animate-slide-in">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-foreground">Sign in to Ravenna</h1>
                    <p className="text-muted-foreground mt-2 text-sm">Welcome back to your financial sanctuary</p>
                </div>
